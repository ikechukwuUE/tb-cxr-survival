...
│   ├── model_utils.py      # TBSurvivalNet Architecture & Cox Loss
...
3. **Katzman et al. (2018).** "DeepSurv: Personalized treatment recommender system using a Cox proportional hazards deep neural network." *BMC Medical Research Methodology.*
